...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        LOGGER.info(('\n' + '%11s' * 10) % ('Epoch', 'GPU_mem', 'bbox_loss', 'obj_loss', 'cls_loss','bbox_ploss', 'obj_ploss', 'cls_ploss','Instances', 'Size'))
        if RANK in {-1, 0}:
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            atk_target, deleted_bbox = bbox_label_poisoning(targets, batch_size=batch_size, img_size=imgs_size, class_num=nc)
